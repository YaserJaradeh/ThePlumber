...
def evaluaterefcand(reference, candidate):
    ...
    for idx, attrib in enumerate(indextriple):
        ...
        if idx == 0:
            ...
            candidatefound, refdictlist, canddictlist, totallist = getrefdict(newreflist, newcandlist, 'PRED', 'PRED',
                                                                              len(subjecttotallist))
            ...
            candidatefound, refdictlist, canddictlist, totallist = getrefdict(newreflist, newcandlist, 'OBJ', 'OBJ',
                                                                              len(subjecttotallist) + len(
                                                                                  predicatetotallist))
    ...
    if (subjectfound == 'n') and (objectfound == 'n'):
        ...
        ngramlength = len(newcandlist)
        newreflist, newcandlist = nonrefwords(newreflist, newcandlist, 1, ngramlength)
        candidatefound2, refdictlist2, canddictlist2, totallist2 = getrefdict(newreflist, newcandlist, 'OBJ', 'SUB',
    ...
    if ((subjectfound == 'n') and (predicatefound == 'n')) and (switchmatchfound == 'n'):
        ...
        candidatefound2, refdictlist2, canddictlist2, totallist2 = getrefdict(newreflist, newcandlist, 'PRED', 'SUB',
                                                                              len(totallist))
    ...
    if ((predicatefound == 'n') and (objectfound == 'n')) and (switchmatchfound == 'n'):
        ...
        candidatefound, refdictlist, canddictlist, totallist = getrefdict(newreflist, newcandlist, 'PRED', 'OBJ',
                                                                          len(subjecttotallist))
        ...
        candidatefound2, refdictlist2, canddictlist2, totallist2 = getrefdict(newreflist, newcandlist, 'OBJ', 'PRED',
...
def calculateSystemScore(totalsemevallist, totalsemevallistpertag, newreflist, newcandlist, fp=None):
    selectedsemevallist = []
    ...
    for idx, candidate in enumerate(newcandlist):
        ...
        for combination in combilist:
            ...
            for zc in zipcombi:
                ...
                f1score = statistics.mean([collectedscores['ent_type']['f1'], collectedscores['partial']['f1'],
                                           collectedscores['strict']['f1'], collectedscores['exact']['f1']])
                combiscore += f1score
    ...
    # print('Correct: ' + str(enttypecorrect) + ' Incorrect: ' + str(enttypeincorrect) + ' Partial: ' + str(
    #     enttypepartial) + ' Missed: ' + str(enttypemissed) +
    #       '\nSpurious: ' + str(enttypespurious) + ' Possible: ' + str(enttypepossible) + ' Actual: ' + str(
    ...
    # print('Correct: ' + str(partialcorrect) + ' Incorrect: ' + str(partialincorrect) + ' Partial: ' + str(
    #     partialpartial) + ' Missed: ' + str(
    #     partialmissed) +
    #       '\nSpurious: ' + str(partialspurious) + ' Possible: ' + str(partialpossible) + ' Actual: ' + str(
    #     partialactual) + '\nPrecision: ' + str(
    #     partialprecision) +
    ...
    # print('Correct: ' + str(strictcorrect) + ' Incorrect: ' + str(strictincorrect) + ' Partial: ' + str(
    #     strictpartial) + ' Missed: ' + str(
    #     strictmissed) +
    #       '\nSpurious: ' + str(strictspurious) + ' Possible: ' + str(strictpossible) + ' Actual: ' + str(
    #     strictactual) + '\nPrecision: ' + str(
    #     strictprecision) +
    ...
    # print('Correct: ' + str(exactcorrect) + ' Incorrect: ' + str(exactincorrect) + ' Partial: ' + str(
    #     exactpartial) + ' Missed: ' + str(
    #     exactmissed) +
    #       '\nSpurious: ' + str(exactspurious) + ' Possible: ' + str(exactpossible) + ' Actual: ' + str(
    #     exactactual) + '\nPrecision: ' + str(
    #     exactprecision) +
    ...
    # print('Correct: ' + str(subenttypecorrect) + ' Incorrect: ' + str(subenttypeincorrect) + ' Partial: ' + str(
    #     subenttypepartial) + ' Missed: ' + str(
    #     subenttypemissed) +
    #       '\nSpurious: ' + str(subenttypespurious) + ' Possible: ' + str(subenttypepossible) + ' Actual: ' + str(
    #     subenttypeactual) + '\nPrecision: ' + str(
    #     subenttypeprecision) +
    ...
    # print('Correct: ' + str(subpartialcorrect) + ' Incorrect: ' + str(subpartialincorrect) + ' Partial: ' + str(
    #     subpartialpartial) + ' Missed: ' + str(
    #     subpartialmissed) +
    #       '\nSpurious: ' + str(subpartialspurious) + ' Possible: ' + str(subpartialpossible) + ' Actual: ' + str(
    #     subpartialactual) + '\nPrecision: ' + str(
    #     subpartialprecision) +
    ...
    # print('Correct: ' + str(substrictcorrect) + ' Incorrect: ' + str(substrictincorrect) + ' Partial: ' + str(
    #     substrictpartial) + ' Missed: ' + str(
    #     substrictmissed) +
    #       '\nSpurious: ' + str(substrictspurious) + ' Possible: ' + str(substrictpossible) + ' Actual: ' + str(
    #     substrictactual) + '\nPrecision: ' + str(
    #     substrictprecision) +
    ...
    # print('Correct: ' + str(subexactcorrect) + ' Incorrect: ' + str(subexactincorrect) + ' Partial: ' + str(
    #     subexactpartial) + ' Missed: ' + str(
    #     subexactmissed) +
    #       '\nSpurious: ' + str(subexactspurious) + ' Possible: ' + str(subexactpossible) + ' Actual: ' + str(
    #     subexactactual) + '\nPrecision: ' + str(
    #     subexactprecision) +
    ...
    # print('Correct: ' + str(predenttypecorrect) + ' Incorrect: ' + str(predenttypeincorrect) + ' Partial: ' + str(
    #     predenttypepartial) + ' Missed: ' + str(
    #     predenttypemissed) +
    #       '\nSpurious: ' + str(predenttypespurious) + ' Possible: ' + str(predenttypepossible) + ' Actual: ' + str(
    #     predenttypeactual) + '\nPrecision: ' + str(
    ...
    # print('Correct: ' + str(predpartialcorrect) + ' Incorrect: ' + str(predpartialincorrect) + ' Partial: ' + str(
    #     predpartialpartial) + ' Missed: ' + str(
    #     predpartialmissed) +
    #       '\nSpurious: ' + str(predpartialspurious) + ' Possible: ' + str(predpartialpossible) + ' Actual: ' + str(
    #     predpartialactual) + '\nPrecision: ' + str(
    ...
    # print('Correct: ' + str(predstrictcorrect) + ' Incorrect: ' + str(predstrictincorrect) + ' Partial: ' + str(
    #     predstrictpartial) + ' Missed: ' + str(
    #     predstrictmissed) +
    #       '\nSpurious: ' + str(predstrictspurious) + ' Possible: ' + str(predstrictpossible) + ' Actual: ' + str(
    #     predstrictactual) + '\nPrecision: ' + str(
    #     predstrictprecision) +
    ...
    # print('Correct: ' + str(predexactcorrect) + ' Incorrect: ' + str(predexactincorrect) + ' Partial: ' + str(
    #     predexactpartial) + ' Missed: ' + str(
    #     predexactmissed) +
    #       '\nSpurious: ' + str(predexactspurious) + ' Possible: ' + str(predexactpossible) + ' Actual: ' + str(
    #     predexactactual) + '\nPrecision: ' + str(
    #     predexactprecision) +
    ...
    # print('Correct: ' + str(objenttypecorrect) + ' Incorrect: ' + str(objenttypeincorrect) + ' Partial: ' + str(
    #     objenttypepartial) + ' Missed: ' + str(
    #     objenttypemissed) +
    #       '\nSpurious: ' + str(objenttypespurious) + ' Possible: ' + str(objenttypepossible) + ' Actual: ' + str(
    #     objenttypeactual) + '\nPrecision: ' + str(
    #     objenttypeprecision) +
    ...
    # print('Correct: ' + str(objpartialcorrect) + ' Incorrect: ' + str(objpartialincorrect) + ' Partial: ' + str(
    #     objpartialpartial) + ' Missed: ' + str(
    #     objpartialmissed) +
    #       '\nSpurious: ' + str(objpartialspurious) + ' Possible: ' + str(objpartialpossible) + ' Actual: ' + str(
    #     objpartialactual) + '\nPrecision: ' + str(
    #     objpartialprecision) +
    ...
    # print('Correct: ' + str(objstrictcorrect) + ' Incorrect: ' + str(objstrictincorrect) + ' Partial: ' + str(
    #     objstrictpartial) + ' Missed: ' + str(
    #     objstrictmissed) +
    #       '\nSpurious: ' + str(objstrictspurious) + ' Possible: ' + str(objstrictpossible) + ' Actual: ' + str(
    #     objstrictactual) + '\nPrecision: ' + str(
    #     objstrictprecision) +
    ...
    # print('Correct: ' + str(objexactcorrect) + ' Incorrect: ' + str(objexactincorrect) + ' Partial: ' + str(
    #     objexactpartial) + ' Missed: ' + str(
    #     objexactmissed) +
    #       '\nSpurious: ' + str(objexactspurious) + ' Possible: ' + str(objexactpossible) + ' Actual: ' + str(
    #     objexactactual) + '\nPrecision: ' + str(
    #     objexactprecision) +
    #       ' Recall: ' + str(objexactrecall) + '\nF1: ' + str(objexactf1))
    # print('-----------------------------------------------------------------')
    if fp is not None:
        row = [str(partialprecision), str(partialrecall), str(partialf1), str(exactprecision), str(exactrecall),
               str(exactf1), str(subexactprecision), str(subexactrecall), str(subexactf1), str(predexactprecision),
               str(predexactrecall), str(predexactf1),
               str(objexactprecision), str(objexactrecall), str(objexactf1)]
        line = '\t'.join(row)
        fp.write(f'{line}')


def calculateExactTripleScore(reflist, candlist, fp=None):
    ...
    f1 = f1_score(mrbin, mcbin, average='macro')  # , zero_division=1

    # print('Full triple scores')
    # print('-----------------------------------------------------------------')
    # print('Precision: ' + str(precision) + ' Recall: ' + str(recall) + '\nF1: ' + str(f1))
    if fp is not None:
        row = [str(precision), str(recall), str(f1)]
        line = '\t'.join(row)
        fp.write(f'\t{line}\n')


def main(reffile, candfile, fp=None):
    ...
    calculateSystemScore(totalsemevallist, totalsemevallistpertag, newreflist, newcandlist, fp)
    calculateExactTripleScore(reflist, candlist, fp)


def real_main(reffile, directory):
    files = glob.glob(f"{directory}{'/' if directory[-1] != '/' else ''}*.xml")
    with open('metrics.tsv', 'w') as output_file:
        headers = '\t'.join(['pipeline', 'partial precision', 'partial recall', 'partial f1',
                             'exact precision', 'exact recall', 'exact f1',
                             'sub precision', 'sub recall', 'sub f1',
                             'pred precision', 'pred recall', 'pred f1',
                             'obj precision', 'obj recall', 'obj f1',
                             'triple precision', 'triple recall', 'triple f1'])
        output_file.write(f"{headers}\n")
        for file in tqdm(files):
            pipeline_number = file[file.rfind('-') + 1:][:-4]
            output_file.write(f'{pipeline_number}\t')
            main(reffile, file, output_file)
        output_file.flush()


if __name__ == '__main__':
    # main(sys.argv[1], sys.argv[2])
    # main('reference.xml', './xml/result-0.xml')
    # real_main('reference.xml', './xml')
    fp = open('metrics.tsv', 'a+')
    headers = '\t'.join(['pipeline', 'partial precision', 'partial recall', 'partial f1',
                         'exact precision', 'exact recall', 'exact f1',
                         'sub precision', 'sub recall', 'sub f1',
                         'pred precision', 'pred recall', 'pred f1',
                         ...
                         'triple precision', 'triple recall', 'triple f1'])
    # for i in range(270):
    #     print(f"fp.write(f'{i}\t')\nmain('reference.xml', './xml/result-{i}.xml', fp)\nprint('done with pipeline {i}')\nfp.flush()")
    # fp.write(f"{headers}\n")
